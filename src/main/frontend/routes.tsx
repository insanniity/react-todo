...
export const {router, routes} = new RouterConfigurationBuilder()
    ...
    //         {path: '/usuarios', element: <ListUsers/>, handle: {title: 'ListUsers'}},
    //         {path: '/usuarios/:id', element: <EditUser />, handle: {title: 'Editar usuario'}},
    //         {path: '/usuarios/add', element: <AddUser />, handle: {title: 'Novo usuario'}}
    //     ]
    // )
    .withFallback(Flow)
